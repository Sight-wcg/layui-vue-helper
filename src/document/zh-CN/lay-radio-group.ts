...
export const attributes: DocumentAttribute[] = [{"name":"v-model","description":"选中值","type":"--","default":"-","value":"-"},{"name":"disabled","description":"是否整体禁用","type":"`boolean`","default":"`false`","value":"`true` `false`"}];
