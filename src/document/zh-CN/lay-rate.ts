...
export const attributes: DocumentAttribute[] = [
  ...
  { name: 'readonly', description: '只读模式', type: '`boolean`', default: '`false`', value: '`true` `false`' },
  { name: 'theme', description: '主题颜色', type: '`string`', default: '`#ffb800`', value: '' },
  {
    name: 'half',
    description: '设定组件是否可以选择半星',
    type: '`boolean`',
    default: '`false`',
    value: 'true` `false`',
  },
