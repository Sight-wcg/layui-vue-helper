...
export const attributes: DocumentAttribute[] = [
  ...
  { name: 'placeholder', description: '默认空提示语', type: '`string`', default: '`请选择`', value: '-' },
  ...
  { name: 'multiple', description: '是否为多选', type: '`boolean`', default: '`false`', value: '`true` `false`' },
  { name: 'create', description: '是否允许创建', type: '`boolean`', default: '`false`', value: '`true` `false`' },
];
