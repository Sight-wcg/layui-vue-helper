...
export const attributes: DocumentAttribute[] = [
  ...
  {
    name: 'size',
    description: '设置文件最大可允许上传的大小，单位 KB。不支持 ie8/9',
    type: '`number`',
    default: '`0`',
    value: '--',
  },
  {
    name: 'multiple',
    description: '是否允许多文件上传。设置 true 即可开启。不支持 ie8/9',
    type: '`boolean`',
    default: '`false`',
    value: '`true` `false`',
  },
  ...
  {
    name: 'drag',
    description: '是否接受拖拽的文件上传，设置 false 可禁用。不支持 ie8/9',
    type: '`boolean`',
    default: '`true`',
    value: '`true` `false`',
  },
  { name: 'disabled', description: '设置文件禁用', type: '`boolean`', default: '`false`', value: '`true` `false`' },
  {
  ...
  {
    name: 'cut',
    description: '是否开启选择图片后检测,设置 true 可开启',
    type: '`boolean`',
    default: '`false`',
    value: '`true` `false`',
  },
