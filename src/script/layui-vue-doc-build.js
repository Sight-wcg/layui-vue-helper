    ...
    if (/\.md$/.test(doc)) {
      ...
      readLine.on('line', (line) => {
        ...
        if (line.includes('Attributes')) {
          filename = 'lay-' + line.replace(/#/g, '').replace('Attributes', '').trim().replace(/ /g, '-').toLocaleLowerCase()
          if (filename.length === 3) {
            filename = 'lay-' + doc.substr(0, doc.length - 3)
          }
          flag = 'attributes'
          skip = 2
          return
        ...
        if (line.includes('Events') && line.includes('###')) {
          filename = 'lay-' + line.replace(/#/g, '').replace('Events', '').trim().replace(/ /g, '-').toLocaleLowerCase()
          if (filename.length === 3) {
            filename = 'lay-' + doc.substr(0, doc.length - 3)
          }
          flag = 'events'
        ...
        if (line.includes('Methods')) {
          filename = 'lay-' + line.replace(/#/g, '').replace('Methods', '').trim().replace(/ /g, '-').toLocaleLowerCase()
          if (filename.length === 3) {
            filename = 'lay-' + doc.substr(0, doc.length - 3)
          }
          flag = 'methods'
        ...
        if (line.includes('Scoped Slots')) {
          filename = 'lay-' + line.replace(/#/g, '').replace('Scoped Slots', '').trim().replace(/ /g, '-').toLocaleLowerCase()
          if (filename.length === 3) {
            filename = 'lay-' + doc.substr(0, doc.length - 3)
          }
          flag = 'scopedSlots'
        ...
        if (line.includes('Slots')) {
          filename = 'lay-' + line.replace(/#/g, '').replace('Slots', '').replace('Slots', '').trim().replace(/ /g, '-').toLocaleLowerCase()
          if (filename.length === 3) {
            filename = 'lay-' + doc.substr(0, doc.length - 3)
          }
          flag = 'slots'
